...
//    }
    ...
    public List<LiveChinaChannelEntity> loadAllLiveChinaChannel() {
        LiveChinaChannelEntityDao dao = openReadableDb().getLiveChinaChannelEntityDao();
        return dao.queryBuilder().orderAsc(LiveChinaChannelEntityDao.Properties.Order)
                .list();
    }

    public void insertOrUpdate(LiveChinaChannelEntity liveChina) {
        LiveChinaChannelEntityDao dao = openWritableDb().getLiveChinaChannelEntityDao();
