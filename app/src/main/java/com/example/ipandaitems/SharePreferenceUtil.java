...
public class SharePreferenceUtil {
    ...
    public SharePreferenceUtil(Context context) {
        sp = context.getSharedPreferences(App.SP_FILE_NAME,
    ...
    public Boolean getIsWXLoginSuccess() {
        return sp.getBoolean("isWXLoginSuccess", false);
    }
    ...
    public Boolean getIsRegistSuccess() {
        return sp.getBoolean("isRegistSuccess", false);
    }
