...
import com.example.ipandaitems.presenter.pandalivepresenter.plfragment.PPLAmaPhotoe8;
...
public class PLF8Specials extends BaseFragment implements PLF2AmaPhotoesView {
    @BindView(R.id.pl_8_recycler)
    XRecyclerView pl8Recycler;
    Unbinder unbinder;
    ...
    protected int layoutID() {
        return R.layout.pl_8specials;
    }
    @Override
    protected void initView(View view) {
        pl8Recycler.setLayoutManager(new LinearLayoutManager(getContext(), LinearLayoutManager.VERTICAL, false));
        pl8Recycler.setRefreshProgressStyle(ProgressStyle.BallSpinFadeLoader);
        pl8Recycler.setLoadingMoreProgressStyle(ProgressStyle.BallSpinFadeLoader);
        PPLAmaPhotoe8 ppa = new PPLAmaPhotoe8(this);
        ppa.initData();
    }
    ...
    public void initData(final PLAmaPhotoes plAmaPhotoes) {
        ...
        if (adapter == null) {
            ...
            pl8Recycler.setAdapter(adapter);
        } else {
            adapter.notifyDataSetChanged();
        }
        pl8Recycler.setLoadingListener(new XRecyclerView.LoadingListener() {
            @Override//下拉刷新
            public void onRefresh() {
                pl8Recycler.refreshComplete();//下拉刷新完成
            }
            ...
            public void onLoadMore() {
                ...
                list.addAll(plAmaPhotoes.getVideo());
                pl8Recycler.loadMoreComplete();//加载更多完成
            }
        });
        ...
        pl8Recycler.setFootView(footview);
