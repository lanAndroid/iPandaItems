...
import com.example.ipandaitems.presenter.pandalivepresenter.plfragment.PPLAmaPhotoe5;
...
public class PLF5Record extends BaseFragment implements PLF2AmaPhotoesView {
    @BindView(R.id.pl_5_recycler)
    XRecyclerView pl5Recycler;
    Unbinder unbinder;
    ...
    protected int layoutID() {
        return R.layout.pl_5record;
    }
    @Override
    protected void initView(View view) {
        pl5Recycler.setLayoutManager(new LinearLayoutManager(getContext(), LinearLayoutManager.VERTICAL, false));
        pl5Recycler.setRefreshProgressStyle(ProgressStyle.BallSpinFadeLoader);
        pl5Recycler.setLoadingMoreProgressStyle(ProgressStyle.BallSpinFadeLoader);
        PPLAmaPhotoe5 ppa = new PPLAmaPhotoe5(this);
        ppa.initData();
    }
    ...
    public void initData(final PLAmaPhotoes plAmaPhotoes) {
        ...
        if (adapter == null) {
            ...
            pl5Recycler.setAdapter(adapter);
        } else {
            adapter.notifyDataSetChanged();
        }
        pl5Recycler.setLoadingListener(new XRecyclerView.LoadingListener() {
            @Override//下拉刷新
            public void onRefresh() {
                pl5Recycler.refreshComplete();//下拉刷新完成
            }
            ...
            public void onLoadMore() {
                ...
                list.addAll(plAmaPhotoes.getVideo());
                pl5Recycler.loadMoreComplete();//加载更多完成
            }
        });
        ...
        pl5Recycler.setFootView(footview);
