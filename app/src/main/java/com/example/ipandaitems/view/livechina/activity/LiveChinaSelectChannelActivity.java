package com.example.ipandaitems.view.livechina.activity;
...
import com.example.ipandaitems.view.livechina.adapter.DragAdapter;
import com.example.ipandaitems.view.livechina.adapter.OtherAdapter;
import com.example.ipandaitems.view.livechina.assist.DragGrid;
import com.example.ipandaitems.view.livechina.assist.OtherGridView;
        ...
        switch (v.getId()) {
            ...
            case R.id.live_china_select_channel_bianji:
                ...
                if (userAdapter.EDIT_TRUE == true) {
                    ...
                    btnSelectLiveChinaEdit.setText("编辑");
                    fugaiLayout.setVisibility(View.VISIBLE);
                    ...
                    btnSelectLiveChinaEdit.setText("完成");
            ...
            switch (parent.getId()) {
                case R.id.userGridView:
                    ...
                    if (userAdapter.getCount() <= 4) {
                        Toast.makeText(this,"栏目区，不能少于四个频道", Toast.LENGTH_SHORT).show();
                        return;
                    }
